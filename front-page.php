                ...
                <div class="card-milestone">
                  ...
                  <div
                    ...
                    style="
                      ...
                      background-image: url('<?php echo get_template_directory_uri() . '/assets/img/home-milestones-001.jpg'; ?>');
                  ...
                  >
                    ...
                    <div class="card-milestone__text-container">
                      ...
                      <p class="card-milestone__text text-medium-small">
                        ...
                        <?php echo __('Ίδρυση του ομίλου ΕΛΛΗΝΙΚΗ ΠΡΩΤΕΙΝΗ το 1995.','realgreekdairies'); ?>
                ...
                <div class="card-milestone">
                  ...
                  <div
                    ...
                    style="
                      ...
                      background-image: url('<?php echo get_template_directory_uri() . '/assets/img/home-milestones-002.jpg'; ?>');
                  ...
                  >
                    ...
                    <div class="card-milestone__text-container">
                      ...
                      <?php echo __('Βραβείο ΚΑΘΑΡΗΣ ΤΕΧΝΟΛΟΓΙΑΣ από τον Ευρωπαίο Επίτροπο Περιβάλλοντος ως αναγνώριση της προσφοράς μας στο περιβάλλον και την προστασία του.','realgreekdairies'); ?>
                ...
                <div class="card-milestone">
                  ...
                  <div
                    ...
                    style="
                      ...
                      background-image: url('<?php echo get_template_directory_uri() . '/assets/img/home-milestones-003.jpg'; ?>');
                  ...
                  >
                    ...
                    <div class="card-milestone__text-container">
                      ...
                      <?php echo __('Ίδρυση Real Greek Brand. Έναρξη δραστηριότητας εξαγωγής τυροκομικών προϊόντων στις ΗΠΑ.','realgreekdairies'); ?>
                ...
                <div class="card-milestone">
                  ...
                  <div
                    ...
                    style="
                      ...
                      background-image: url('<?php echo get_template_directory_uri() . '/assets/img/home-milestones-004.jpg'; ?>');
                  ...
                  >
                    ...
                    <div class="card-milestone__text-container">
                      ...
                      <?php echo __('Έναρξη δραστηριότητας διαδικτυακού καταστήματος realgreekprotein.gr','realgreekdairies'); ?>
                ...
                <div class="card-milestone">
                  ...
                  <div
                    ...
                    style="
                      ...
                      background-image: url('<?php echo get_template_directory_uri() . '/assets/img/home-milestones-005.jpg'; ?>');
                  ...
                  >
                    ...
                    <div class="card-milestone__text-container">
                      ...
                      <?php echo __('Είσοδος ως ιδιώτης επενδυτής στον Αγροτικό Γαλακτομικό Συνεταιρισμό Μονεμβασιάς «Πάρνων».','realgreekdairies'); ?>
                ...
                <div class="card-milestone">
                  ...
                  <div
                    ...
                    style="
                      ...
                      background-image: url('<?php echo get_template_directory_uri() . '/assets/img/home-milestones-006.jpg'; ?>');
                  ...
                  >
                    ...
                    <div class="card-milestone__text-container">
                      ...
                      <?php echo __('Εκμετάλλευση Γαλακτοβιομηχανίας Οικοφάρμας Τριπόλεως. Επενδύσεις στη καινοτομία παραγωγής τυροκομικών προϊόντων.','realgreekdairies'); ?>
